...
let neighbor = {
    ...
    Trieste:["Venezia","Tyrolia","Vienna","Budapest","Serbia","Albania"],
    Budapest:["Rumania","Serbia","Trieste","Vienna","Galicia"],
    Galicia:["Warsaw","Ukraine","Rumania","Budapest","Vienna","Bohemia","Silesia"],
    Warsaw:["Galicia","Silesia","Prussia","Livonia","Moscow","Ukraine"],
    Vienna:["Trieste","Budapest","Galicia","Tyrolia","Bohemia"],
    Tyrolia:["Venezia","Piemonte","Munich","Bohemia","Vienna","Trieste"],
    Bohemia:["Munich","Silesia","Tyrolia","Galicia","Vienna"],
    Prussia:["Livonia","Warsaw","Silesia","Berlin"],
    Silesia:["Warsaw","Prussia","Berlin","Munich","Galicia","Bohemia"],
    Berlin:["Silesia","Kiel","Prussia","Munich"],
    Kiel:["Denmark","Holland","Ruhr","Berlin","Munich"],
    Munich:["Burgundy","Ruhr","Kiel","Berlin","Silesia","Tyrolia","Bohemia"],
    Ruhr:["Belgium","Holland","Burgundy","Kiel","Munich"],
    Denmark:["Kiel"],
    Holland:["Kiel","Ruhr","Belgium"],
    Belgium:["Holland","Ruhr","Picardy","Burgundy"],
    Venezia:["Tyrolia","Trieste","Piemonte","Tuscany","Roma","Apulia"],
    Piemonte:["Marseilles", "Venezia","Tyrolia","Tuscany"],
    Tuscany:["Piemonte","Venezia","Roma"],
    Roma:["Tuscany","Venezia","Apulia","Napoli"],
    Apulia:["Venezia","Roma","Napoli"],
    Napoli:["Apulia","Roma", "Tunisia"],
    Tunisia:["Napoli"],
    Burgundy:["Belgium","Ruhr","Munich","Marseilles","Gascony","Paris","Picardy"],
    Marseilles:["Gascony","Spain","Burgundy","Piemonte"],
    Gascony:["Spain","Marseilles","Brest","Paris","Burgundy"],
    Brest:["Gascony","Picardy","Paris"],
    Picardy:["Brest","Belgium","Burgundy","Paris"],
    Paris:["Gascony","Burgundy","Brest","Picardy"],
    Spain:["Gascony", "Marseilles","Portugal"],
    Portugal:["Spain"],
    Clyde:["Edinburgh","Liverpool"],
    Edinburgh:["Clyde","Liverpool","York"],
    Liverpool:["Clyde", "Edinburgh","York","Wales"],
    York:["Edinburgh","Liverpool","Wales","London"],
    London:["York","Wales"],
    Wales:["Liverpool","York","London"],
    "Barents Sea":["Norwegian Sea"],
    "Norweigan Sea":["North Atlantic", "North Sea"],
    "North Sea":["Skagerrak","Helgoland Bigbt","English Channel","Baltic Sea","Norwegian Sea"],
    "Helgoland Bigbt":["North Sea", "Baltic Sea"],
    "Skagerrak":["North Sea"],
    "Baltic Sea":["Helgoland Bigbt","North Sea","Gulf of Botbnia"],
    "Gulf of Botbnia":["Baltic Sea"],
    "North Atlantic":["Irish Sea", "Mid Atlantic", "Norwegian Sea"],
    "Irish Sea":["English Channel","North Atlantic","Mid Atlantic"],
    "English Channel":["North Sea","Irish Sea","Mid Atlantic"],
    "Mid Atlantic":["North Atlantic","Irish Sea","English Channel","West Mediterranean"],
    "West Mediterranean":["Mid Atlantic","Gulf of Lyon","Tyrbennian Sea"],
    "Gulf of Lyon":["West Mediterranean","Tyrbennian Sea"],
    "Tyrbennian Sea":["Gulf of Lyon", "West Mediterranean", "Ionian Sea"],
    "Ionian Sea":["Tyrbennian Sea", "Adriatic Sea","Aegean Sea","East Mediterranean"],
    "Adriatic Sea":["Ionian Sea"],
    "Aegean Sea":["Ionian Sea","East Mediterranean"],
    "East Mediterranean":["Ionian Sea", "Aegean Sea"]
}
